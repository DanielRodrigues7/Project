...
<html>
	...
	<body>
		...
		<div class="section">
			<div class="linha">
				<section>
					<h2>Selecione um paciente para dieta</h2><br>
						<table class="table table-hover">
						  <tr><th>Nome</th><th>Cadastrado em</th><th></th></tr>
						  <?php						  
									while($row = $query->fetch_assoc()){
										...
										echo "<td>".$data."</td>";
										echo "<td><a href='cadastroDeGrupos.php?id=".$id."'><button class='btn btn-default'>Selecionar</button></a></td></tr>";						
										//echo "<td><a href='cadastroDeGrupos.php?id=".$id."'><button class='btn btn-default'>Selecionar</button></a></td></tr>";									
									}
						   ?>
						</table>		
